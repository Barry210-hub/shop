...
//CREATING UPLOAD ENDPIONT FOE IMAGES
...
//Creating api for deletation product
...
//creating Api to fetch All the product
...
const fetchUser = async (req,res,next)=>{
    ...
    if (!token) {
        res.status(401).send({errors:'Please authenticate using a validi token'})
    }
    else{
        try{
...
//creating endpiont for adding products in cart
...
//creating endpiont for remove products
...
//creating api endpionts to get cartdata
